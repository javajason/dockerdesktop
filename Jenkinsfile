...
DOCKER_IMAGE_REPOSITORY = "dockerdesktop"
...
if(DOCKER_ORCHESTRATOR.toLowerCase() == "kubernetes"){
    ...
    DOCKER_APPLICATION_FQDN = "${DOCKER_IMAGE_REPOSITORY}.${DOCKER_USER_CLEAN}.${DOCKER_KUBE_DOMAIN_NAME}"
}
else if (DOCKER_ORCHESTRATOR.toLowerCase() == "swarm"){
    DOCKER_SERVICE_NAME = "${DOCKER_USER_CLEAN}-${DOCKER_IMAGE_REPOSITORY}"
    DOCKER_STACK_NAME = "${DOCKER_USER_CLEAN}-${DOCKER_IMAGE_REPOSITORY}"
    DOCKER_UCP_COLLECTION_PATH = "/Shared/Private/${DOCKER_USER}"

    DOCKER_APPLICATION_FQDN = "${DOCKER_IMAGE_REPOSITORY}.${DOCKER_USER_CLEAN}.${DOCKER_SWARM_DOMAIN_NAME}"
}
else {

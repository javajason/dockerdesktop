...
DOCKER_IMAGE_REPOSITORY = "jedemo2"
...
if(DOCKER_ORCHESTRATOR.toLowerCase() == "kubernetes"){
    ...
    DOCKER_APPLICATION_FQDN = "jedemo2.${DOCKER_USER_CLEAN}.${DOCKER_KUBE_DOMAIN_NAME}"
}
    ...
    DOCKER_APPLICATION_FQDN = "jedemo2.${DOCKER_USER_CLEAN}.${DOCKER_SWARM_DOMAIN_NAME}"
}
else {
